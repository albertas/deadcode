...
def _get_unused_items(defined_items: List[CodeItem], used_names: Set[str]) -> List[CodeItem]:
...
def _match(name: Union[str, Path], patterns: List[str], case: bool = True) -> bool:
