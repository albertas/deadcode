...
class TestVerboseOutput(BaseTestCase):
    def test_colorful_output(self):
        ...
        self.assertEqual(
            unused_names,
            (
                "tests/files/variables.py:1:0: \x1b[91mDC010\x1b[0m Variable "
                "`\x1b[1munused_global_variable\x1b[0m` is never used\n"
                "tests/files/variables.py:2:0: \x1b[91mDC010\x1b[0m Variable "
                "`\x1b[1mANOTHER_GLOBAL_VARIABLE\x1b[0m` is never used\n"
                "tests/files/variables.py:3:0: \x1b[91mDC010\x1b[0m Variable "
    ...
    def test_no_color_option(self):
        ...
        self.assertEqual(
            ...
            (
                ...
                "tests/files/variables.py:2:0: DC010 Variable `ANOTHER_GLOBAL_VARIABLE` is never used\n"
                "tests/files/variables.py:3:0: DC010 Variable `third_global_varialbe3` is never used"
            ),
        )
